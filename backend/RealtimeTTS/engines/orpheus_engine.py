...
class OrpheusEngine(BaseEngine):
    """
    Real-time Text-to-Speech (TTS) engine for the Orpheus model via API Server/Endpoint.
    ...
    def __init__(
        ...
        Args:
            api_url (str): Endpoint URL for the API Server/Endpoint.
    ...
    def _generate_tokens(self, prompt: str):
        """
        Generate a token stream using the API Server/Endpoint.
