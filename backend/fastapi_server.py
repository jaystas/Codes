    ...
    async def main_tts_loop(self, send_audio_callback: Callable[[bytes], Awaitable[None]]):
        ...
        while not self._shutdown_event.is_set():
            try:
                ...
                voice_ctx = await self.get_or_create_voice_context(
                    character=sentence_tts.speaker,
                ...
                chunk_index = 0
                async for audio_bytes in self.tts_service.generate_audio_stream(
                    text=sentence_tts.text,
